...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Webruble server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Webruble server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WBR features */
        {"webruble", "masternode", &masternode, true, true, false},
        {"webruble", "masternodelist", &masternodelist, true, true, false},
        {"webruble", "mnbudget", &mnbudget, true, true, false},
        {"webruble", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"webruble", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"webruble", "mnsync", &mnsync, true, true, false},
        {"webruble", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"webruble", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use webrubled, or the -server option to webruble-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Webruble Alert\" admin@foo.com\n"),
...
{
    return "> webruble-cli " + methodname + " " + args + "\n";
}
