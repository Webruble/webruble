...
#if defined(NDEBUG)
#error "Webruble cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Webruble Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) return 1050000 * COIN;

	int64_t nSubsidy = 0;

	if(nHeight > 0 && nHeight <= 5000) {
        nSubsidy = 1 * COIN;
	} else if (nHeight > 5000 && nHeight <= 50000) {
		nSubsidy = 25 * COIN;
	} else if (nHeight > 50000 && nHeight <= 150000) {
		nSubsidy = 50 * COIN;
	} else if (nHeight > 150000 && nHeight <= 500000) {
		nSubsidy = 25 * COIN;
	} else if (nHeight > 500000 && nHeight <= 7250007) {
		nSubsidy = 10 * COIN;
	} else if (nHeight > 7250007) {
		nSubsidy = 10 * COIN;
	}
...
{
    RenameThread("webruble-scriptch");
