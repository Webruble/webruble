...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Webruble Core"),
     ...
     * override -datadir in the webruble.conf file in the default data directory
     * (to be consistent with webrubled behavior)
     */
    if (dataDir != getDefaultDataDirectory())
