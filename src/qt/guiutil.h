...
/** Utility functions used by the WBR Qt UI.
 */
namespace GUIUtil
{
...
// Render WBR addresses in monospace font
...
// Parse "webruble:" URI into recipient object, return true on successful parsing
