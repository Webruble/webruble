                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Webruble-Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Webruble address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and webruble: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Webruble Core"), this);
    aboutAction->setStatusTip(tr("Show information about Webruble Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Webruble"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Webruble addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Webruble addresses"));
    ...
    openAction->setStatusTip(tr("Open a Webruble: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Webruble Core help message to get a list with possible Webruble command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Webruble Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Webruble network", "", count));
}
...
{
    QString strTitle = tr("Webruble Core"); // default title
