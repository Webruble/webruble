...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Webruble Core webruble-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  webruble-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded webruble transaction") + "\n" +
                               "  webruble-tx [options] -create [commands]   " + _("Create hex-encoded webruble transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded webruble transaction
