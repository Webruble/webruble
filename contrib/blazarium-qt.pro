...
RESOURCES += src/qt/webruble.qrc src/qt/webruble_locale.qrc

TRANSLATIONS += src/qt/locale/webruble_bg.ts \
                src/qt/locale/webruble_de.ts \
                src/qt/locale/webruble_en.ts \
                src/qt/locale/webruble_es.ts \
                src/qt/locale/webruble_fi.ts \
                src/qt/locale/webruble_fr.ts \
                src/qt/locale/webruble_it.ts \
                src/qt/locale/webruble_ja.ts \
                src/qt/locale/webruble_pl.ts \
                src/qt/locale/webruble_pt.ts \
                src/qt/locale/webruble_ru.ts \
                src/qt/locale/webruble_sk.ts \
                src/qt/locale/webruble_sv.ts \
                src/qt/locale/webruble_vi.ts \
                src/qt/locale/webruble_zh_CN.ts \
                src/qt/locale/webruble_zh_TW.ts
